...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      user_role: "admin" | "organization" | "supporter"
    }
    CompositeTypes: {
      [_ in never]: never
    }
